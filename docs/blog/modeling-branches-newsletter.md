...
[&larr; Back to Blog]({{ '/docs/blog' | relative_url }}){: .blog-back-link}
  ...
  <div class="blog-post-header">
    ...
    <p class="blog-post-subtitle">Linearize your conditional flows using Given/When/Then and maintain clear, readable models</p>
  ...
  <div class="blog-post-featured-image">
    <img src="{{ '/assets/images/blog/modeling-branches-newsletter.png' | relative_url }}" alt="Modeling Branches in Event Modeling">
  </div>
...
<div class="blog-post-image">
  <img src="{{ '/assets/images/blog/modeling-branches-newsletter-1.png' | relative_url }}" alt="Given/When/Then Example">
</div>
...
<div class="blog-post-image">
  <img src="{{ '/assets/images/blog/modeling-branches-newsletter-2.png' | relative_url }}" alt="Alternative Modeling">
</div>
...
<div class="blog-post-image">
  <img src="{{ '/assets/images/blog/modeling-branches-newsletter-3.png' | relative_url }}" alt="Linearized Flow">
</div>
...
<section class="related-posts">
  ...
  <div class="related-posts-grid">
    <a href="{{ '/docs/blog/eventmodeling-with-given-when-then' | relative_url }}" class="related-post-card">
      <div class="related-post-content">
        <h3>Event Modeling with Given-When-Then</h3>
        <p>Applying BDD patterns to Event Modeling</p>
