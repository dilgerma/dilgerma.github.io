...
<section class="related-posts">
  ...
  <div class="related-posts-grid">
    <a href="{{ '/docs/blog/modeling-external-systems' | relative_url }}" class="related-post-card">
      <div class="related-post-content">
        <h3>Modeling External Systems</h3>
        <p>How to represent external systems in your Event Models</p>
