...
[&larr; Back to Blog]({{ '/docs/blog' | relative_url }}){: .blog-back-link}
  ...
  <div class="blog-post-header">
    <h1>How to Bring Event Modeling to Your Company - Start Small, Win Big</h1>
    <p class="blog-post-subtitle">Event Modeling isn't an "all or nothing" approach. Here's how to benefit from it even without massive upfront investment.</p>
    <div class="blog-post-meta">
      <span>November 29, 2025</span>
      <span>10 min read</span>
      <span>Event Modeling & Team Adoption</span>
    </div>
  </div>

  <div class="blog-post-featured-image">
    <img src="{{ '/assets/images/blog/bring-event-modeling-company.png' | relative_url }}" alt="Bring Event Modeling to Your Company">
  </div>
...
Before that! Big announcement for me.
The course "Implementing Eventsourcing" is now live.
...
<div class="blog-post-image">
  <img src="{{ '/assets/images/blog/bring-event-modeling-company-1.png' | relative_url }}" alt="Event Modeling Course and Book Bundle">
</div>
...
More accurate software plannings
Clearly described requirements - no questions asked in development
effective software slicing - allows parallel work without stumbling over each other all the time (merge conflict hell.. anyone?)
