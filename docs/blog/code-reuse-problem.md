...
[&larr; Back to Blog]({{ '/docs/blog' | relative_url }}){: .blog-back-link}
  ...
  <div class="blog-post-header">
    ...
    <p class="blog-post-subtitle">Should we reuse simple classes like DTOs across the system? Ten years ago, my answer would have been "Yes! Keep it DRY." Today, my perspective has shifted. Let me explain.</p>
...
<div class="blog-post-image">
  <img src="{{ '/assets/images/blog/code-reuse-problem-1.png' | relative_url }}" alt="The DRY Principle Question">
</div>
...
<div class="blog-post-image">
  <img src="{{ '/assets/images/blog/code-reuse-problem-2.png' | relative_url }}" alt="The Mapping Chaos Argument">
</div>
...
<div class="blog-post-image">
  <img src="{{ '/assets/images/blog/code-reuse-problem-3.png' | relative_url }}" alt="Real Life Example">
</div>
