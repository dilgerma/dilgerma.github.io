...
[&larr; Back to Podcast]({{ '/docs/podcast' | relative_url }}){: .blog-back-link}
  ...
  <div class="blog-post-header">
    <h1>Episode 14 - AI Code Generation Works Best Within Strict Boundaries</h1>
    <p class="blog-post-subtitle">How AI tools like Claude and Cursor perform when generating code for event-sourced systems</p>
  ...
  <div class="video-container">
    <iframe width="560" height="315" src="https://www.youtube.com/embed/AJgMPcvlhqs" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  </div>
