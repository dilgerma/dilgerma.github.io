...
[&larr; Back to Podcast]({{ '/docs/podcast' | relative_url }}){: .blog-back-link}
  ...
  <div class="blog-post-header">
    <h1>Episode 19 - Slices Transform Fixed-Cost Contracting</h1>
    <p class="blog-post-subtitle">How event slices became units of autonomous work that enable fixed-cost contracting without subjective estimation</p>
  ...
  <div class="video-container">
    <iframe width="560" height="315" src="https://www.youtube.com/embed/nVPfDLHrqkY" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  </div>
